...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'jobeet', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ed8e2daa6bd005f9679d2d0d8d6f5777ad5b29021bd8fb243d70eaffa9f7e18c');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminGroups(array('jobeet' => array('label' => 'jobeet', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'ens.jobeet.admin.category', 'label' => 'Categories', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'ens.jobeet.admin.job', 'label' => 'Jobs', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cee31ba067541901e8cbe68a9586cfb9dd04708a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57634ccaefe311.27061337')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'cee31ba067541901e8cbe68a9586cfb9dd04708a',
            'locale' => 'en',
            ...
            'kernel.secret' => 'cee31ba067541901e8cbe68a9586cfb9dd04708a',
